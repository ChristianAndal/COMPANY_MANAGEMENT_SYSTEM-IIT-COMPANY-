...
<section class="home-section">
    <div class="home-content">
        ...
        <span class="text">Current Project</span>
    </div>
...
<div class="container py-3">
    <div class="row mt-6">
        <?php
           $allowedStatuses = ['Planning', 'Designing', 'Development', 'Testing', 'Implementation'];

         
           $statusCondition = implode("','", $allowedStatuses);
           $query = "SELECT * FROM project WHERE status IN ('$statusCondition')";
